...
# Heroku зазвичай надає DATABASE_URL для PostgreSQL.
# Якщо ви використовуєте локально, можете залишити sqlite:///database.db
        ...
        if not inspector.has_table('users'):
            ...
            if 'user_status' not in existing_columns:
                with engine.connect() as connection:
                    # ВИПРАВЛЕНО: Використання одинарних лапок для строкового DEFAULT значення
...
# --- 5. Функції роботи з користувачами та загальні допоміжні функції ---
@error_handler
